...
%       .modsel_acc_avg_p [scalar] : Binomial test p-value.
...
for i_eval = 1 : n_design_evals
    ...
    % Compute the binomial test p-value
    modsel_acc_avg_p = ...
        myBinomTest(modsel_n_correct_total, curr_n_exp_total, 0.5);
    ...
    eval_stats(i_eval) = struct(...
        ...
        'modsel_acc_avg_p', modsel_acc_avg_p,...
...
for i_pair = 1 : n_des_pairs
    % Initialize results for the pair
        ...
        [~,p_cs] = prop_test(modsel_n_correct_total , n_exp_total, false);
