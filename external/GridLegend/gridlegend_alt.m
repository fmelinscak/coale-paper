function hlgd = gridlegend_alt(varargin)
...
% Defaults
line_width = 35; % [px] width of line object in legend
margin_height = 2; % [px] vertical margin between rows
margin_width = 4; % [px] horizontal margin between columns
padding_height = 1; % [px] vertical padding at edge of legend
padding_width = 4; % [px] horizontal padding at edge of legend
margin_outer = 4; % [px] outside margin surrounding legend
