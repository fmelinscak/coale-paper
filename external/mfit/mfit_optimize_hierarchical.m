function results = mfit_optimize_hierarchical(likfun,param,data,nstarts,verbose)
    ...
    if nargin < 4 || isempty(nstarts); nstarts = 1; end
    ...
    while iter < maxiter
        ...
        results = mfit_optimize(likfun,param,data,nstarts,verbose);
