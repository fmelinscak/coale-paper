function [bar_xtick,hb,he]=errorbar_groups_alt(bar_input,errorbar_input,varargin)
%
% ERRORBAR_GROUPS_ALT: grouped bar plot with error bars, customizable.
%
% ERRORBAR_GROUPS_ALT(bar_input,errorbar_input) produces a bar plot of matrix
...
%
% ERRORBAR_GROUPS_ALT(bar_input,errorbar_lower,errorbar_upper) allows
...
% this function.
%
% bar_xtick = ERRORBAR_GROUPS_ALT(...) returns the X coordinates for the center
% of each group of bars.
%
% [...,hb,he] = ERRORBAR_GROUPS_ALT(...) returns the handles to the bars
% (produced by BAR) and the error bars (produced by ERRORBAR).
%
% ERRORBAR_GROUPS_ALT(...,'ParameterName',ParameterValue) allows customizing
% the display.
%
...
%
% 'clear_axis' : boolean indicating whether the axis is cleared before
% plotting into it. Default value: true.
%
% Examples:
%
% Basic usage:
...
%   errorbar_groups_alt(bar_input,errorbar_input);
%
...
%   errorbar_groups_alt(bar_input,errorbar_lower,errorbar_upper);
%
